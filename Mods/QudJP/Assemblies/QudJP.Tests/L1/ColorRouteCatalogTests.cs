...
internal static class ColorRouteCatalog
{
    ...
    internal static readonly SortedDictionary<string, int> ExpectedSymbolOccurrences =
        new SortedDictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/ActiveEffectTextTranslator.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
            ...
            ["Mods/QudJP/Assemblies/src/Patches/JournalNotificationTranslator.cs|JournalPatternTranslator.Translate("] = 1,
            ...
            ["Mods/QudJP/Assemblies/src/Patches/SinkPrereqSetDataTranslationPatch.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
