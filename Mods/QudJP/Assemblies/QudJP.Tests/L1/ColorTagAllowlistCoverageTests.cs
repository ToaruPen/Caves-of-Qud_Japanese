...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PetEitherOrExplodeTranslationPatch.cs:123:TryTranslate"] = "Delegates capture and boundary restoration to matched owner-route branches.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1184:IsAlreadyLocalizedPopupText"] = "Predicate only; it compares stripped and original text.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:257:TranslatePopupTextForRoute"] = "Strips only for direct-marker and already-localized detection before producer routes own restoration.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:290:TryTranslatePerformOfferTradeWaterMessage"] = "Popup sink handoff delegates capture restoration to the PerformOffer owner-template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:302:TryTranslateHasNothingToTradeMessage"] = "Popup sink handoff delegates capture restoration to the has-nothing owner-template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:314:TryTranslateTradeUiPopupText"] = "Delegates capture restoration to branch-specific RestoreCapture helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:911:ShouldSkipMessagePatternTranslation"] = "Predicate only; it strips markup to classify already-localized visible popup text.",
