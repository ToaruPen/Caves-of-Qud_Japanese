...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/ActiveEffectTextTranslator.cs:145:TryTranslateTemplate"] = "Delegates restoration to the template helper selected by the matched rule.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DesalinationPelletFragmentTranslator.cs:21:TryTranslatePopupMessage"] = "Delegates capture restoration to RestoreCapture for captured popup fragments.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1290:IsAlreadyLocalizedPopupText"] = "Predicate only; it compares stripped and original text.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:358:TryTranslatePopupProducerText"] = "Delegates capture restoration to template/exact branch helpers.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:332:TryTranslateTradeUiPopupText"] = "Delegates capture restoration to branch-specific RestoreCapture helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:929:ShouldSkipMessagePatternTranslation"] = "Predicate only; it strips markup to classify already-localized visible popup text.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:507:TryTranslateCoProcessorTemplate"] = "Delegates restoration to the template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:547:TryTranslateCounterweightedTemplate"] = "Delegates restoration to the template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:574:TryTranslateDisguiseReputationTemplate"] = "Restores capture-local color wrappers and whole-source Qud wrappers in the matched branch.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:619:TryTranslateElementalDamageTemplate"] = "Delegates restoration to the template helper.",
